...
const jobValidator = [
  ...
  body("fullDescription.jobResponsibility")
    ...
    .withMessage("Job Responsibility must contain at least 1 responsibility"),

  body("fullDescription.jobRequirement")
    .custom((value) => Array.isArray(value) && value.length > 0)
    .withMessage("Job Requirement must contain at least 1 requirement"),
  ...
  body("type")
    ...
    .withMessage(
      "Type must be one of: Full-time, Part-time, Hybrid, Internship, Contract, Volunteer, Remote"
    ),
  ...
  body("currency")
    ...
    .withMessage(
      "Currency must be a 3-letter ISO 4217 currency code (e.g., USD, EUR)"
    ),
  ...
  body("experienceLevel")
    ...
    .withMessage(
      "Experience Level must be either Entry Level, Mid Level, or Senior Level"
    ),
