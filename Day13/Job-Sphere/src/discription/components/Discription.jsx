          ...
          <div className=" w-full h- ">
            <div className=" w-full max-w-[783px] tracking-wide flex flex-col gap-2 items-start">
              ...
              <p className="  text-[20px]  leading-8 ">
                We are seeking a highly skilled and creative Senior UI/UX
                Designer to join our dynamic team in Lagos. As a Senior UI/UX
                Designer, you will play a crucial role in designing intuitive
                and engaging user interfaces and enhancing user experience
                across various digital platforms. You will collaborate closely
                with cross-functional teams, including product managers,
                developers, and stakeholders, to bring innovative ideas to life
                and ensure a seamless user journey. If you are passionate about
                creating top-notch digital experiences and have a keen eye for
                design, we would love to have you on board!
              </p>
            </div>
            <div className=" w-full max-w-[783px] tracking-wide flex flex-col gap-2 items-start">
              ...
              <ul className=" text-[20px]  leading-8 ">
                ...
                <li className=" list-disc">
                  applications. Conduct user research, usability testing, and
                  gather
                </li>
                <li className=" list-disc">
                  feedback to improve designs. Create wireframes, prototypes,
                  and
                </li>
                <li className=" list-disc">
                  high-fidelity designs using design tools like Figma, Adobe XD,
                  or
                </li>
                <li className=" list-disc">
                  Sketch. Collaborate with product managers and developers to
                  ensure
                </li>
                <li className=" list-disc">
                  design consistency and feasibility. Stay updated with the
                  latest
                </li>
                <li className=" list-disc">
                  UI/UX trends and best practices to ensure optimal user
                  experience.
                </li>
                <li className=" list-disc">
                ...
                <li className=" list-disc">
                  and feedback. Ensure designs are aligned with brand guidelines
                  and
                </li>
