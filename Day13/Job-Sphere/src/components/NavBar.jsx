    ...
    <section className=" w-full  h-20 bg-white flex justify-evenly  items-center p-4 shadow-md border-b border-blue-600">
      ...
      <div className=" w-1/4 max-w-[340px]
       ...
       flex justify-evenly items-center">
        <button className=" py-2 px-10 bg-[#0034D1] rounded text-white hover:scale-110 transition-all ">Login</button>
        <button className=" py-2 px-10 rounded blue_border hover:bg-[#0034D1] hover:text-white hover:scale-110 transition-all ">Sign In</button>
      </div>
